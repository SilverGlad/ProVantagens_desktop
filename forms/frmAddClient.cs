...
namespace ProVantagensApp
{
    public partial class frmAddClient : Form
    {
        ...
        async void setData()
        {
            ...
            {
                {"accessLevel", int.Parse(cboNvAcesso.Text)},
                {"name", txtName.Text},
                {"address", address},
                {"cpf", txtCPFCNPJ.Text},
                {"dtn", txtDtn.Text},
        ...
        private void txtBtnCel1_CheckedChanged(Object sender, EventArgs e)
        {
        ...
        private void txtBtnTel2_CheckedChanged(Object sender, EventArgs e)
        {
            if (txtBtnTel2.Checked == true)
            {
                txtBtnCel2.Checked = false;
                txtPhone2.Mask = "(00) 0000-0000";
            }
        }

        private void txtBtnCel2_CheckedChanged(Object sender, EventArgs e)
        {
            if (txtBtnCel2.Checked == true)
            {
                txtBtnTel2.Checked = false;
                txtPhone2.Mask = "(00) 0 0000-0000";
            }
        }

        private void txtEstadoCivil_SelectedIndexChanged(Object sender, EventArgs e)
        {
            if(txtEstadoCivil.Text == "Casado(a)")
            {
                txtNomeConjuge.Enabled = true;
            }
            else
            {
                txtNomeConjuge.Enabled = false;
